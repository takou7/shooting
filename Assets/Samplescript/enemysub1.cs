...
public class Enemy2 : MonoBehaviour {
    ...
    public int enemy2HP = 50;  // enemyの体力
    ...
    private EnemyManager2 enemyManager2;

    void Start() {
        // 初期移動方向を設定
        ChangeDirection();
        enemyManager2 = FindObjectOfType<EnemyManager2>(); // EnemyManagerを見つける
    }
    ...
    void Update() {
        ...
        {
            // 敵が破壊される
            enemyManager2.StartCoroutine(enemyManager2.RespawnEnemy());
            Destroy(gameObject);
            Genpower ();
        }
    }
